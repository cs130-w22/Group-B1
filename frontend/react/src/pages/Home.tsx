        ...
        <div className="home-inner">
          ...
          <div className="home-buttons_wrapper">
            ...
            <div className="home-signup">
              <Link to="/signup">
                <Unicons.UilSignin size={login_icon_size} className="home-signin" />
                <p>Sign Up</p>
              </Link>
            </div>
          </div>
          ...
          <div className="home-row">
            <div className="home-col">
              ...
              <div className="home-quote_wrapper">
                ...
                <div>
                  <p className="home-quote">"Finding roommates that have the same hobbies as me has
            ...
            <div className="home-col">
              ...
              <div className="home-quote_wrapper">
                ...
                <div>
                  <p className="home-quote">"The clean layout definitely makes finding your ideal
            ...
            <div className="home-col">
              ...
              <div className="home-quote_wrapper">
                ...
                <div>
                  <p className="home-quote">"Getting a direct line of communication to my future roommates
