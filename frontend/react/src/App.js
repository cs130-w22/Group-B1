...
// stub data
const firstnames = ['John', 'Joe', 'Katie', 'Lauren', 'Mariana', 'Katniss', 'Peter', 'Tyler', 'Tara', 'Ezekiel'];
const lastnames = ['Smith', 'Cooper', 'Westfield', 'Everdeen', 'Rennel', 'Miller', 'Steinbech', 'Reinhardt'];
const personalities = ['extrovert, party-lover | 2-bedroom, urban', 'introvert, gamer | 2-bedroom, suburban', 'introvert, bookworm | 2-bedroom, urban', 'extrovert, foodie | bunk beds, urban'];
let myList = [];
for (let i = 0; i < 30; i++) {
  myList.push({
